...
function writeCredits(rom, random)
{
	...
	rom.set(
		[
			0xA4, 0xD2, 0xE2, 0xD2, 0x32, 0xD3, 0x8D, 0xD3, 0xBA, 0xD3, 0xFE, 0xD3, 0xB1, 0xD4, 0xD0, 0xD4, 0x00, 0xD5, 0x40, 0xD5, 0x5F, 0xD4
		],
		0x01D28E);
	...
	//BASED ON THE SMW RANDOMIZER BY AUTHORBLUES
	rom.set(
		[
			0x08, 0x42, 0x41, 0x53, 0x45, 0x44, 0x20, 0x4F, 0x4E, 0x20, 0x54, 0x48, 0x45, 0x00, 0x0B, 0x53,
			0x4D, 0x57, 0x20, 0x52, 0x41, 0x4E, 0x44, 0x4F, 0x4D, 0x49, 0x5A, 0x45, 0x52, 0x00, 0x0E, 0x42,
			0x59, 0x20, 0x41, 0x55, 0x54, 0x48, 0x4F, 0x52, 0x42, 0x4C, 0x55, 0x45, 0x53, 0x00, 0x00, 0x00
		],
		0x01D4D0);

	//TODO : include BinarySplit in credits
	//SPECIAL THANKS STEPHANIE RANCOURT THE ULTIMA COMMUNITY
	rom.set(
		[
	...
	rom.set(
		[
			0x0B, 0x55, 0x4C, 0x54, 0x49, 0x4D, 0x41, 0x20, 0x56, 0x49, 0x00, 0x11, 0x54, 0x48, 0x45, 0x20,
			0x46, 0x41, 0x4C, 0x53, 0x45, 0x20, 0x50, 0x52, 0x4F, 0x50, 0x48, 0x45, 0x54, 0x00, 0x00, 0x00
		],
		0x01D540);
}

function fixText(rom, random)
{
